        ...
        <div className='app-container'>
          <div className='forgot-layout' style={{backgroundColor: 'white', textAlign: 'center'}}>
            ...
            <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
              ...
              {cellError || emailError ? <p style={{color: 'red'}}>Ocurrió un problema, intenta nuevamente</p> : null}
              {notFound ? <p style={{color: 'red'}}>No hay ningún usuario asociado a {userMail}</p> : null}
            <div style={{margin: '1rem auto', width: '250px', paddingBottom: '1rem'}}>
